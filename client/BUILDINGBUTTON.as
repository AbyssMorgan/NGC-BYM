   ...
   public class BUILDINGBUTTON extends BUILDINGBUTTON_CLIP
   {
      ...
      public function Setup(param1:int, param2:Boolean = true) : void
      {
         ...
         if(!_loc8_)
         {
            ...
            {
               _loc8_ = "buttons/buildings/" + this._buildingProps.buildingbuttons[BASE._buildingsStored["bl" + this._id].Get() - 1] + ".jpg";
            }
            else if(Boolean(this._buildingProps.buildingbuttons) && this._buildingProps.buildingbuttons.length > 0)
            {
               _loc8_ = "buttons/buildings/" + this._buildingProps.buildingbuttons[0] + ".jpg";
            }
            else
            {
               _loc8_ = "buttons/buildings/" + this._id + ".jpg";
            }
         }
