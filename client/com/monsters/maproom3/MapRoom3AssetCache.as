package com.monsters.maproom3
{
	...
	public class MapRoom3AssetCache
	{
		...
		internal static const CELL_ICON_STRONGHOLD_HEAT:String = "worldmap/icons/guard_tower_heat.png";
		...
		internal static const CELL_ICON_WILD_MONSTER_BASE:String = "worldmap/icons/wild_monster_base.png";

		internal static const CELL_ICON_WILD_MONSTER_BASE_HEAT:String = "worldmap/icons/wild_monster_base_heat.png";
		...
		internal static const CELL_ICON_HELLRAISER_EVENT_BASE_HEAT:String = "worldmap/icons/hellraiser_event_base_heat.png";

		internal static const CELL_ICON_HELLRAISER_EVENT_BASE_TILE_HEAT:String = "worldmap/icons/hellraiser_event_base_tile_heat.png";

		internal static const CELL_ICON_HELLRAISER_EVENT_BASE_NGC:String = "worldmap/icons/hellraiser_event_base_ngc.png";

		internal static const CELL_ICON_HELLRAISER_EVENT_BASE_TILE_NGC:String = "worldmap/icons/hellraiser_event_base_tile_ngc.png";
		
		internal static const CELL_ICON_FORTIFICATION:String = "worldmap/icons/fortification.png";
		
		internal static const CELL_ICON_FORTIFICATION_EAST:String = "worldmap/icons/fortification_east.png";
		
		internal static const CELL_ICON_FORTIFICATION_WEST:String = "worldmap/icons/fortification_west.png";
		
		internal static const CELL_ICON_FORTIFICATION_NORTH_EAST:String = "worldmap/icons/fortification_north_east.png";
		
		internal static const CELL_ICON_FORTIFICATION_NORTH_WEST:String = "worldmap/icons/fortification_north_west.png";
		
		internal static const CELL_ICON_FORTIFICATION_SOUTH_EAST:String = "worldmap/icons/fortification_south_east.png";
		
		internal static const CELL_ICON_FORTIFICATION_SOUTH_WEST:String = "worldmap/icons/fortification_south_west.png";
		...
		internal static const CELL_ICON_FORTIFICATION_HEAT:String = "worldmap/icons/fortification_heat.png";

		internal static const CELL_ICON_FORTIFICATION_EAST_HEAT:String = "worldmap/icons/fortification_east_heat.png";

		internal static const CELL_ICON_FORTIFICATION_WEST_HEAT:String = "worldmap/icons/fortification_west_heat.png";

		internal static const CELL_ICON_FORTIFICATION_NORTH_EAST_HEAT:String = "worldmap/icons/fortification_north_east_heat.png";

		internal static const CELL_ICON_FORTIFICATION_NORTH_WEST_HEAT:String = "worldmap/icons/fortification_north_west_heat.png";

		internal static const CELL_ICON_FORTIFICATION_SOUTH_EAST_HEAT:String = "worldmap/icons/fortification_south_east_heat.png";

		internal static const CELL_ICON_FORTIFICATION_SOUTH_WEST_HEAT:String = "worldmap/icons/fortification_south_west_heat.png";

		internal static const CELL_ICON_FULLY_FORTIFIED_BACK_HEAT:String = "worldmap/icons/fully_fortified_back_heat.png";

		internal static const CELL_ICON_FULLY_FORTIFIED_FRONT_HEAT:String = "worldmap/icons/fully_fortified_front_heat.png";
		
		internal static const CELL_ICON_FORTIFICATION_LIGHT_BLUE:String = "worldmap/icons/fortification_light_blue.png";
		
		internal static const CELL_ICON_FORTIFICATION_LIGHT_GREEN:String = "worldmap/icons/fortification_light_green.png";
		
		internal static const CELL_ICON_FORTIFICATION_LIGHT_RED:String = "worldmap/icons/fortification_light_red.png";
		
		internal static const CELL_ICON_FORTIFICATION_LIGHT_YELLOW:String = "worldmap/icons/fortification_light_yellow.png";
		...
		private static const IMAGES_TO_LOAD:Array = [
			CELL_ICON_DAMAGE_PROTECTION,
			...
			CELL_ICON_STRONGHOLD_BUFF_EFFECT_ENEMY,
			CELL_ICON_STRONGHOLD_BUFF_EFFECT_PLAYER,
			CELL_ICON_STRONGHOLD_BUFF_EFFECT_MIXED,
			CELL_ICON_WILD_MONSTER_BASE,
			CELL_ICON_WILD_MONSTER_BASE_HEAT,
			CELL_ICON_HELLRAISER_EVENT_BASE,
			CELL_ICON_HELLRAISER_EVENT_BASE_TILE,
			CELL_ICON_HELLRAISER_EVENT_BASE_HEAT,
			CELL_ICON_HELLRAISER_EVENT_BASE_TILE_HEAT,
			CELL_ICON_HELLRAISER_EVENT_BASE_NGC,
			CELL_ICON_HELLRAISER_EVENT_BASE_TILE_NGC,
			CELL_ICON_FORTIFICATION,
			CELL_ICON_FORTIFICATION_EAST,
			CELL_ICON_FORTIFICATION_WEST,
			CELL_ICON_FORTIFICATION_NORTH_EAST,
			CELL_ICON_FORTIFICATION_NORTH_WEST,
			CELL_ICON_FORTIFICATION_SOUTH_EAST,
			CELL_ICON_FORTIFICATION_SOUTH_WEST,
			CELL_ICON_FULLY_FORTIFIED_BACK,
			CELL_ICON_FULLY_FORTIFIED_FRONT,
			CELL_ICON_FORTIFICATION_HEAT,
			CELL_ICON_FORTIFICATION_EAST_HEAT,
			CELL_ICON_FORTIFICATION_WEST_HEAT,
			CELL_ICON_FORTIFICATION_NORTH_EAST_HEAT,
			CELL_ICON_FORTIFICATION_NORTH_WEST_HEAT,
			CELL_ICON_FORTIFICATION_SOUTH_EAST_HEAT,
			CELL_ICON_FORTIFICATION_SOUTH_WEST_HEAT,
			CELL_ICON_FULLY_FORTIFIED_BACK_HEAT,
			CELL_ICON_FULLY_FORTIFIED_FRONT_HEAT,
			CELL_ICON_FORTIFICATION_LIGHT_BLUE,
			CELL_ICON_FORTIFICATION_LIGHT_GREEN,
			CELL_ICON_FORTIFICATION_LIGHT_RED,
			CELL_ICON_FORTIFICATION_LIGHT_YELLOW,
			CELL_OVERLAY_GLOW_RED,
			CELL_OVERLAY_GLOW_BLUE,
			CELL_OVERLAY_GLOW_GREEN,
			CELL_OVERLAY_GLOW_YELLOW,
			HUD_BOOKMARK_THUMBNAIL_RESOURCE,
			HUD_BOOKMARK_THUMBNAIL_STRONGHOLD,
			HUD_BUTTON_FULL_SCREEN,
			HUD_BUTTON_ZOOM_IN,
			HUD_BUTTON_ZOOM_OUT,
			HUD_BUTTONS_BAR_BACKGROUND,
			HUD_COORDINATES_BACKGROUND,
			MOUSEOVER_BACKGROUND,
			MOUSEOVER_BUTTON_BACKGROUND,
			MOUSEOVER_BUTTON_ENTER,
			MOUSEOVER_BUTTON_ENTER_ROLLOVER,
			MOUSEOVER_BUTTON_SCOUT_ATTACK,
			MOUSEOVER_BUTTON_SCOUT_ATTACK_ROLLOVER,
			MOUSEOVER_BUTTON_BOOKMARK_ADD,
			MOUSEOVER_BUTTON_BOOKMARK_ADD_ROLLOVER,
			MOUSEOVER_BUTTON_BOOKMARK_REMOVE,
			MOUSEOVER_BUTTON_BOOKMARK_REMOVE_ROLLOVER,
			MOUSEOVER_BUTTON_SEND_MESSAGE,
			MOUSEOVER_BUTTON_SEND_MESSAGE_ROLLOVER,
			MOUSEOVER_BUTTON_INVITE_TO_ALLIANCE,
			MOUSEOVER_BUTTON_INVITE_TO_ALLIANCE_ROLLOVER,
			MOUSEOVER_BUTTON_REQUEST_TRUCE,
			MOUSEOVER_BUTTON_REQUEST_TRUCE_ROLLOVER,
			MOUSEOVER_ICON_TRUCE,
			DAMAGE_BAR
		];
