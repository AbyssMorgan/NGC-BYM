package com.monsters.display
{
	...
	public class ImageCache
	{
		...
		private static const LOCAL_ASSET_ROOT:String = "assets/";
		...
		private function initLoadable(queue:Loadable) : void
		{
			...
			l.loadState = LOADING;
			req_str = "app:/assets/" + l.key;
			l.loader.contentLoaderInfo.addEventListener(Event.COMPLETE, function(e:Event):void {
				onAssetComplete(l);
			});
			l.loader.contentLoaderInfo.addEventListener(IOErrorEvent.IO_ERROR, function(e:IOErrorEvent):void {
				onError(l);
			});
			l.loader.load(new URLRequest(req_str), new LoaderContext(false));
			load.push(l);
		}
