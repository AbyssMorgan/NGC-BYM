package
{
	...
	public class GAME extends Sprite
	{
		...
		public function GAME()
		{
			...
			var server_data:Object = GAME.loadJSON("server.json");
			if(server_data.hasOwnProperty('url')){
				GLOBAL.serverUrl = String(server_data.url);
			}
		...
		public static function saveJSON(file_name:String, data:Object):void
		{
		...
		public static function loadJSON(file_name:String):Object
		{
			var file:File = File.applicationStorageDirectory.resolvePath(file_name);
