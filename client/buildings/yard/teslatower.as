package buildings.yard {
	...
	public class teslatower {
		...
		public static const DATA:Object = {
			...
			"cls":BUILDING25,
			"stats":[
				{"range":250, "damage":100, "rate":55, "speed":10, "splash":0, "duration":10}, // Level 1
				{"range":270, "damage":120, "rate":55, "speed":10, "splash":0, "duration":15}, // Level 2
				{"range":300, "damage":140, "rate":55, "speed":10, "splash":0, "duration":20}, // Level 3
				{"range":320, "damage":160, "rate":55, "speed":10, "splash":0, "duration":25}, // Level 4
				{"range":340, "damage":180, "rate":55, "speed":10, "splash":0, "duration":25}, // Level 5
				{"range":360, "damage":200, "rate":55, "speed":10, "splash":0, "duration":30}, // Level 6
				{"range":380, "damage":220, "rate":55, "speed":10, "splash":0, "duration":30}, // Level 7
				{"range":400, "damage":250, "rate":55, "speed":10, "splash":0, "duration":35}, // Level 8
				{"range":420, "damage":300, "rate":55, "speed":10, "splash":0, "duration":35}, // Level 9
				{"range":440, "damage":350, "rate":55, "speed":10, "splash":0, "duration":40}, // Level 10
				{"range":460, "damage":400, "rate":55, "speed":10, "splash":0, "duration":40}, // Level 11
				{"range":480, "damage":450, "rate":55, "speed":10, "splash":0, "duration":45}, // Level 12
				{"range":500, "damage":500, "rate":55, "speed":10, "splash":0, "duration":45}, // Level 13
				{"range":520, "damage":550, "rate":50, "speed":10, "splash":0, "duration":50},  // Level 14
				{"range":540, "damage":600, "rate":45, "speed":10, "splash":0, "duration":55},  // Level 15
				{"range":560, "damage":650, "rate":40, "speed":10, "splash":0, "duration":60},  // Level 16
			],
			"costs":[
				...
				{"r1":new SecNum(10000000000), "r2":new SecNum(10000000000), "r3":new SecNum(10000000000), "r4":new SecNum(10000000000), "r6": new SecNum(2), "time":new SecNum(86400 * 15), "re":[[14,1,22],[12,1,3],[145,1,7]]}, // Level 15
				{"r1":new SecNum(25000000000), "r2":new SecNum(25000000000), "r3":new SecNum(25000000000), "r4":new SecNum(25000000000), "r6": new SecNum(5), "time":new SecNum(86400 * 16), "re":[[14,1,24],[12,1,3],[145,1,9]]}, // Level 16
			],
			"can_fortify":true,
			"fortify_costs":[
			...
			"imageData":{
				...
				"16":{
					"anim":["anim.ngc.png",new Rectangle(-25,-15,27,53),55],
					"top":["top.ngc.png",new Point(-33,-57)],
					"shadow":["shadow.3.jpg",new Point(-38,18)],
					"animdamaged":["anim.ngc.damaged.png",new Rectangle(-26,-19,30,57),55],
					"topdamaged":["top.ngc.damaged.png",new Point(-46,-58)],
					"shadowdamaged":["shadow.3.jpg",new Point(-44,21)],
					"topdestroyed":["top.ngc.destroyed.png",new Point(-46,6)],
					"shadowdestroyed":["shadow.3.jpg",new Point(-44,17)],
					"topdestroyedfire":["top.3.destroyed.fire.png",new Point(-46,6)]
				}
			},
