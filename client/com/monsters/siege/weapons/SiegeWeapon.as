package com.monsters.siege.weapons
{
   ...
   public class SiegeWeapon
   {
      ...
      private static const _IMAGE_FOLDER_URL:String = "buttons/siege/";
      ...
      public function SiegeWeapon()
      {
         ...
         this.video = "app:/assets/videos/" + this.weaponID + "400x175.flv";
      ...
      {
         return _IMAGE_FOLDER_URL + this.weaponID + "_tiny.png";
      }
