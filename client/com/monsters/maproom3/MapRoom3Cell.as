package com.monsters.maproom3
{
	...
	public class MapRoom3Cell implements IMapRoomCell
	{
		...
		public function get conquerorPoints() : Number
		{
			return !!this.m_CellData ? this.m_CellData.conquerorPoints : 0;
		}

		public function get baseValue() : Number
		{
			return !!this.m_CellData ? this.m_CellData.baseValue : 0;
		}
		...
		public function GetLocalisedCellTypeName(level:int) : String
		{
			switch(this.cellType)
			{
				...
				default: {
					...
					{
						if(this.m_CellData.wildMonsterTribeId == 5){
							return "MI Power: " + GLOBAL.FormatNumberNormal(this.baseValue);
						} else if(this.m_CellData.wildMonsterTribeId == 4){
