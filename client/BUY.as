   ...
   public class BUY
   {
      ...
      private static function FBCNcpRender(param1:String, param2:MovieClip) : String
      {
         ...
         else
         {
            ...
            {
               img = "buttons/buildings/" + buildingProps.buildingbuttons[BASE._buildingsStored["bl" + _building._type].Get() - 1] + ".jpg";
            }
            else if(Boolean(buildingProps.buildingbuttons) && buildingProps.buildingbuttons.length >= _building._lvl.Get())
            {
               img = "buttons/buildings/" + buildingProps.buildingbuttons[_building._lvl.Get() - 1] + ".jpg";
            }
            ...
            {
               img = "buttons/buildings/" + _building._type + ".jpg";
            }
