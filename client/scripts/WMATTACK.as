      ...
      public static function SpawnA(param1:Array) : Array
      {
         ...
         while(_loc8_ < param1.length)
         {
            ...
            if(_type == TYPE_SWARM)
            {
               ...
               {
                  _loc9_ += 8;
                  _loc4_ = GRID.ToISO(Math.cos(_loc9_ * 0.0174532925) * (1200 + param1[_loc8_][3] / 2),Math.sin(_loc9_ * 0.0174532925) * (1200 + param1[_loc8_][3] / 2),0);
                  _loc5_ = GRID.ToISO(Math.cos(_loc9_ * 0.0174532925) * 1200,Math.sin(_loc9_ * 0.0174532925) * 1200,0);
