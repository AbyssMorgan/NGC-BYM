package com.monsters.effects.particles
{
	...
	public class ParticleDamageItem extends ParticleDamageItem_CLIP
	{
		...
		public function getLootColor(param1:uint) : String
		{
			switch(param1)
			{
				case BRESOURCE.RESOURCE_TWIGS: return "723228";
				case BRESOURCE.RESOURCE_PEBBLES: return "999999";
				case BRESOURCE.RESOURCE_PUTTY: return "FF00FF";
				case BRESOURCE.RESOURCE_GOO: return "00FF00";
				case BRESOURCE.RESOURCE_COAL: return "3F3B36";
				case BRESOURCE.RESOURCE_BONE: return "F0E6C5";
				case BRESOURCE.RESOURCE_SULFUR: return "EEED71";
				case BRESOURCE.RESOURCE_MAGMA: return "D95300";
