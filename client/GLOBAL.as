package
{
   ...
   public class GLOBAL
   {
      ...
      public static var apiVersionSuffix:String = "ngc-v1.4.6r1";
      ...
      public static function SetBuildingProps():void
      {
		...
		if(LOGIN._playerID == 7 && BASE.isMainYard){
			_buildingProps[1 - 1].quantity = [200];
			_buildingProps[2 - 1].quantity = [200];
			_buildingProps[3 - 1].quantity = [200];
			_buildingProps[4 - 1].quantity = [200];
			_buildingProps[5 - 1].quantity = [200];
			_buildingProps[6 - 1].quantity = [200];
			_buildingProps[8 - 1].quantity = [200];
			_buildingProps[9 - 1].quantity = [200];
			_buildingProps[10 - 1].quantity = [200];
			_buildingProps[11 - 1].quantity = [200];
			_buildingProps[12 - 1].quantity = [200];
			_buildingProps[13 - 1].quantity = [200];
			_buildingProps[14 - 1].quantity = [200];
			_buildingProps[15 - 1].quantity = [200];
			_buildingProps[16 - 1].quantity = [200];
			_buildingProps[17 - 1].quantity = [5000];
			_buildingProps[19 - 1].quantity = [200];
			_buildingProps[20 - 1].quantity = [200];
			_buildingProps[21 - 1].quantity = [200];
			_buildingProps[22 - 1].quantity = [200];
			_buildingProps[23 - 1].quantity = [200];
			_buildingProps[24 - 1].quantity = [200];
			_buildingProps[25 - 1].quantity = [200];
			_buildingProps[26 - 1].quantity = [200];
			_buildingProps[51 - 1].quantity = [200];
			_buildingProps[112 - 1].quantity = [200];
			_buildingProps[113 - 1].quantity = [200];
			_buildingProps[115 - 1].quantity = [200];
			_buildingProps[116 - 1].quantity = [200];
			_buildingProps[117 - 1].quantity = [200];
			_buildingProps[118 - 1].quantity = [200];
			_buildingProps[128 - 1].quantity = [200];
			_buildingProps[129 - 1].quantity = [200];
			_buildingProps[132 - 1].quantity = [200];
			_buildingProps[133 - 1].quantity = [200];
			_buildingProps[134 - 1].quantity = [200];
			_buildingProps[136 - 1].quantity = [200];
			_buildingProps[137 - 1].quantity = [200];
			_buildingProps[138 - 1].quantity = [200];
			_buildingProps[139 - 1].quantity = [200];
			_buildingProps[140 - 1].quantity = [200];
			_buildingProps[142 - 1].quantity = [200];
			_buildingProps[143 - 1].quantity = [500];
			_buildingProps[144 - 1].quantity = [200];
			_buildingProps[145 - 1].quantity = [200];
			_buildingProps[146 - 1].quantity = [200];
			_buildingProps[147 - 1].quantity = [200];
			_buildingProps[148 - 1].quantity = [200];
			_buildingProps[149 - 1].quantity = [200];
			_buildingProps[150 - 1].quantity = [200];
			_buildingProps[151 - 1].quantity = [200];
			_buildingProps[152 - 1].quantity = [200];
			_buildingProps[153 - 1].quantity = [200];
			_buildingProps[154 - 1].quantity = [200];
