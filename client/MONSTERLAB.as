package
{
	...
	public class MONSTERLAB extends BFOUNDATION
	{
			...
			_powerupProps = {
				"C3":{
					...
					"costs":[
						...
						[108000, 60 * 60 * 24], // Level 3
						[432000, 60 * 60 * 24], // Level 4
						[1728000, 60 * 60 * 24], // Level 5
						[6912000, 60 * 60 * 24], // Level 6
					],
					"effect":[
						150, // Level 1
						300, // Level 2
				...
				"C4":{
					...
					"costs":[
						...
						[144000, 60 * 60 * 24], // Level 3
						[576000, 60 * 60 * 24], // Level 4
						[2304000, 60 * 60 * 24], // Level 5
						[9216000, 60 * 60 * 24], // Level 6
					],
					"effect":[
						1, // Level 1
						2, // Level 2
				...
				"C7":{
					...
					"costs":[
						...
						[2000000, 60 * 60 * 24], // Level 3
						[8000000, 60 * 60 * 24], // Level 4
						[32000000, 60 * 60 * 24], // Level 5
						[128000000, 60 * 60 * 24], // Level 6
					],
					"effect":[
						1.0, // Level 1
						1.5, // Level 2
				...
				"C8":{
					...
					"costs":[
						...
						[4500000, 60 * 60 * 24], // Level 3
						[18000000, 60 * 60 * 24], // Level 4
						[72000000, 60 * 60 * 24], // Level 5
						[288000000, 60 * 60 * 24], // Level 6
					],
					"effect":[
						0.1, // Level 1
						0.2, // Level 2
				...
				"C5":{
					...
					"costs":[
						...
						[5120000, 60 * 60 * 24], // Level 3
						[20480000, 60 * 60 * 24], // Level 4
						[81920000, 60 * 60 * 24], // Level 5
						[327680000, 60 * 60 * 24], // Level 6
					],
					"effect":[
						0.2, // Level 1
						0.3, // Level 2
				...
				"C9":{
					...
					"costs":[
						...
						[6000000, 60 * 60 * 24], // Level 3
						[24000000, 60 * 60 * 24], // Level 4
						[96000000, 60 * 60 * 24], // Level 5
						[384000000, 60 * 60 * 24], // Level 6
					],
					"effect":[
						0, // Level 1
						4, // Level 2
				...
				"C13":{
					...
					"costs":[
						...
						[22500000, 60 * 60 * 24], // Level 3
						[90000000, 60 * 60 * 24], // Level 4
						[360000000, 60 * 60 * 24], // Level 5
						[1440000000, 60 * 60 * 24], // Level 6
					],
					"effect":[
						1, // Level 1
						2, // Level 2
				...
				"C14":{
					"name":"Additional damage multiplier",
					"order":9,
					...
					"costs":[
						...
						[27000000, 60 * 60 * 24], // Level 3
						[108000000, 60 * 60 * 24], // Level 4
						[432000000, 60 * 60 * 24], // Level 5
						[1728000000, 60 * 60 * 24], // Level 6
					],
					"effect":[
						0.5, // Level 1
						1.0, // Level 2
		...
		public function CanPowerup(param1:String, param2:int) : Object
		{
			...
			if(Boolean(GLOBAL.player.m_upgrades[param1]) && GLOBAL.player.m_upgrades[param1].powerup == 6)
			{
				return {
					"error":true,
