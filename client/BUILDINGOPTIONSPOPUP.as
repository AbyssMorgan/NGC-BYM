   ...
   public class BUILDINGOPTIONSPOPUP extends BUILDINGOPTIONSPOPUP_CLIP
   {
      ...
      private function Render(param1:String) : String
      {
         ...
         if(str == "fortify")
         {
            ...
            img = "buttons/fortify/" + "fort" + nextFortifyLevel + ".png";
         ...
         else
         {
            ...
            {
               img = "buttons/buildings/" + buildingProps.buildingbuttons[BASE._buildingsStored["bl" + this._building._type].Get() - 1] + ".jpg";
            }
            else if(Boolean(buildingProps.buildingbuttons) && buildingProps.buildingbuttons.length >= this._building._lvl.Get())
            {
               img = "buttons/buildings/" + buildingProps.buildingbuttons[this._building._lvl.Get() - 1] + ".jpg";
            }
            else if(Boolean(buildingProps.buildingbuttons) && buildingProps.buildingbuttons.length > 0)
            {
               img = "buttons/buildings/" + buildingProps.buildingbuttons[0] + ".jpg";
            }
            else
            {
               img = "buttons/buildings/" + this._building._type + ".jpg";
            }
