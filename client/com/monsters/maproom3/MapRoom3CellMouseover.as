package com.monsters.maproom3
{
	...
	public class MapRoom3CellMouseover extends Sprite
	{
		...
		private var m_ProfilePicture:Bitmap;
		...
		public function MapRoom3CellMouseover()
		{
			...
			this.m_ProfilePicture = new Bitmap();
		...
		private function SetInfo(param1:MapRoom3Cell) : void
		{
			...
			{
				ImageCache.GetImageWithCallBack("worldmap/rollover/player.png", this.OnProfilePictureLoaded, true, 1);
		...
		private function ClearInfo() : void
		{
			...
			this.m_ProfilePicture.bitmapData = null;
			this.m_ProfilePicture.visible = false;
	  	...
	  	private function OnProfilePictureLoaded(param1:String, param2:BitmapData) : void
		{
			this.m_ProfilePicture.bitmapData = param2;
