package com.monsters.maproom3.data
{
	...
	public class MapRoom3CellData
	{
		...
		private var m_ConquerorPoints:Number = 0;

		private var m_BaseValue:Number = 0;
		...
		public function Map(cellData:Object) : void
		{
			...
			this.m_ConquerorPoints = cellData.hasOwnProperty("cq") ? Number(cellData["cq"]) : 0;
			this.m_BaseValue = cellData.hasOwnProperty("bv") ? Number(cellData["bv"]) : 0;
