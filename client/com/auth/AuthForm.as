    ...
    public class AuthForm extends Sprite
    {
        ...
        private function Loading():void
        {
            ...
            if (GLOBAL.versionMismatch)
            {
                loadingTitle.y = 140;
                errMessage.y = 190;
				ImageCache.GetImageWithCallBack("popups/fantastic.png", function(param1:String, param2:BitmapData):void {
 					var img:Bitmap = Bitmap(param2);
        ...
        public function disposeUI():void
        {
            ...
            if (loader)
            {
                loader.contentLoaderInfo.removeEventListener(Event.COMPLETE, function():void {
