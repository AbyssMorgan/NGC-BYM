	...
	public class bi_snipertower {
		...
		public static const DATA:Object = {
			...
			"imageData":{
				...
				18:{
					"anim":["anim.ngc.png",new Rectangle(-56,-86,85,81),30],
					"top":["top.ngc.png",new Point(-35,-5)],
					"shadow":["shadow.1.jpg",new Point(-50,12)],
					"animdamaged":["anim.ngc.damaged.png",new Rectangle(-52,-90,85,81),30],
					"topdamaged":["top.ngc.damaged.png",new Point(-40,-9)],
					"shadowdamaged":["shadow.1.jpg",new Point(-50,9)],
					"topdestroyed":["top.ngc.destroyed.png",new Point(-43,-8)],
					"shadowdestroyed":["shadow.1.jpg",new Point(-54,2)]
				}
			},
