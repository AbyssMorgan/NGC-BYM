...
export const STRUCTURE_LEVELS: Record<number, number[]> = {
	...
	[EnumYardType.OUTPOST]: [
		...
		65, 65, 65, 65, 65, 65, 65, 65, 65, 65, 65, 65,             // 12 %
		70, 70, 70, 70, 70, 70, 70, 70, 70, 70,                     // 10 %
		75, 75, 75, 75, 75, 75, 75, 75,                             //  8 %
		80, 80, 80, 80, 80, 80,                                     //  6 %
		100, 100, 100,                                              //  3 %
		120,                                                        //  1 %
	],
	[EnumYardType.MOLOCH_OUTPOST]: [
		...
		55, 55, 55, 55, 55, 55, 55, 55, 55, 55, 55, 55, 55, 55, 55, 50, 50, 50,         // 18 %
		60, 60, 60, 60, 60, 60, 60, 60, 60, 60, 60, 60, 60, 60, 60, 60,                 // 16 %
		65, 65, 65, 65, 65, 65, 65, 65, 65, 65, 65, 65, 65, 65,                         // 14 %
		70, 70, 70, 70, 70, 70, 70, 70, 70, 70, 70, 70,                                 // 12 %
		75, 75, 75, 75, 75, 75, 75, 75, 70, 70,                                         // 10 %
		80, 80, 80, 80, 80, 80,                                                         //  6 %
		// 100, 100, 100,                                                                  //  3 %
		// 120,                                                                            //  1 %
	],
