package com.monsters.effects
{
	...
	public class ResourceBombs
	{
		...
		public static function Data() : void
		{
			_bombs = {
				"tw0":{
					...
					"cost":100000,
					"resource":1,
					"image":"buttons/catapult/twigs1.png",
					"col":0,
					"dropTarget":2,
					"catapultLevel":1
				},
				"tw1":{
					...
					"cost":5000000,
					"resource":1,
					"image":"buttons/catapult/twigs2.png",
					"col":1,
					"dropTarget":2,
					"catapultLevel":1
				},
				"tw2":{
					...
					"cost":25000000,
					"resource":1,
					"image":"buttons/catapult/twigs3.png",
					"col":2,
					"dropTarget":2,
					"catapultLevel":5
				},
				"pb0":{
					...
					"cost":100000,
					"resource":2,
					"image":"buttons/catapult/pebbles1.png",
					"col":0,
					"dropTarget":2,
					"catapultLevel":2
				},
				"pb1":{
					...
					"cost":2000000,
					"resource":2,
					"image":"buttons/catapult/pebbles2.png",
					"col":1,
					"dropTarget":2,
					"catapultLevel":2
				},
				"pb2":{
					...
					"cost":10000000,
					"resource":2,
					"image":"buttons/catapult/pebbles3.png",
					"col":2,
					"dropTarget":2,
					"catapultLevel":2
				},
				"pb3":{
					...
					"cost":50000000,
					"resource":2,
					"image":"buttons/catapult/pebbles4.png",
					"col":3,
					"dropTarget":2,
					"catapultLevel":6
				},
				"pu0":{
					...
					"cost":100000,
					"resource":3,
					"image":"buttons/catapult/putty1.png",
					"col":0,
					"dropTarget":3,
					"catapultLevel":3
				},
				"pu1":{
					...
					"cost":5000000,
					"resource":3,
					"image":"buttons/catapult/putty2.png",
					"col":1,
					"dropTarget":3,
					"catapultLevel":3
				},
				"pu2":{
					...
					"cost":10000000,
					"resource":3,
					"image":"buttons/catapult/putty3.png",
					"col":2,
					"dropTarget":3,
					"catapultLevel":3
				},
				"pu3":{
					...
					"cost":25000000,
					"resource":3,
					"image":"buttons/catapult/putty4.png",
					"col":3,
					"dropTarget":3,
					"catapultLevel":7
				}
		...
		{
			if(!_mc) return;
			if((new Date()).getTime() < _mc.enableTime) return;
